	...
	<div class="container">
		...
		<section  id="berita" class="berita">
			<div class="container">
				...
				<h5>Instagram</h5>
				<img src="assets/img/logo474.png" width="95">
					<p>Sekolah terbaik di Purwakarta</p><br/>
					<p>Kegiatan ini dilaksanakan tanggal 19 Agustus 2024 di sekitar lingkungan MAS MAI Purwakarta. Kegiatan menanam tanaman hias sebenarya sudah menjadi budaya di kalangan pelajar sebagai contoh gerakan Desember hijau, lomba membuat taman, memberikan label pada setiap tanaman dan lain sebagainya.</p>
